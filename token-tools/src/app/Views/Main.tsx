      ...
      <Popover.Root onOpenChange={() => setHelpShown(!HelpShown)}>
        ...
        <Content sideOffset={5}>
          <Paragraph css={{ color: "white", cursor: "default" }}>
            Select 1 or more elements on the figma canvas to edit the token
            property. Please keep in mind the more elements that are selected
            the longer it will take to apply the token.
          </Paragraph>
        </Content>
      </Popover.Root>
      <ThemeControl />
