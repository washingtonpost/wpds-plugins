...
function CommandCenter(command, tokenName) {
  ...
  switch (command) {
    ...
    case "set-border-radius":
      ...
      console.log(_token);
      parent.postMessage(
        { pluginMessage: { type: "set-border-radius", token: _token.value } },
        "*"
      );
      break;
    case "set-font-size":
      ...
      parent.postMessage(
        { pluginMessage: { type: "set-font-size", token: _token.value } },
        "*"
      );
      break;
    case "set-line-height":
      ...
      parent.postMessage(
        { pluginMessage: { type: "set-line-height", token: _token.value } },
        "*"
      );
      break;
    default:
