...
export default function Main() {
	...
	return (
		<>
			<Header>Adaptive Color Theme</Header>
			<Paragraph>
				Take your existing color styles in Figma and create adaptive
				themes based on contrast, saturation and lightness. To learn
				more about adaptive colors read{" "}
				<a
					href="https://github.com/adobe/leonardo#what-is-adaptive-color"
					target="_blank"
				>
					here
				</a>
